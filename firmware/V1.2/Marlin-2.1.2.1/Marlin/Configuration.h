...
#define STRING_CONFIG_H_AUTHOR "(lnxd, Marlin 2.1.2.1)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 20.5122, 22.5122 }
    #define DEFAULT_Ki_LIST { 1.793, 1.793 }
    #define DEFAULT_Kd_LIST { 58.6648, 58.6648 }
  #else
    #define DEFAULT_Kp 20.5122
    #define DEFAULT_Ki 1.793
    #define DEFAULT_Kd 58.6648
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 115.417
  #define DEFAULT_bedKi 21.2165
  #define DEFAULT_bedKd 418.581
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 186.2 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -33, -2, -1.9 }
...
#define X_BED_SIZE 235 - 5
#define Y_BED_SIZE 235 - 6
 ...
 */
#if ANY(BLINKM, RGB_LED, NEO_GRBW, PCA9632, PCA9533, NEOPIXEL_LED)
